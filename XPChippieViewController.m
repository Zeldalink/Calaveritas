...
@interface XPChippieViewController ()

@end

@implementation XPChippieViewController
...
- (void)viewDidLoad
{
    ...
    [imagenController setImage:[UIImage imageNamed:@"hippie.png"]];
    UIImage *calaverita=[UIImage imageNamed:@"hippie.png"];
