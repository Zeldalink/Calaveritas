//
//  XPCPapelIndicadoViewController.m
//  Calaveritas
//
...
@interface XPCPapelIndicadoViewController ()

@end

@implementation XPCPapelIndicadoViewController
...
- (void)viewDidLoad
{
    ...
    [imagenController setImage:[UIImage imageNamed:@"papelpicado.png"]];
    UIImage *calaverita=[UIImage imageNamed:@"papelpicado.png"];
