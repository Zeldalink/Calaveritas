...
@interface XPCedHardyViewController ()

@end

@implementation XPCedHardyViewController
@synthesize name;
...
- (void)viewDidLoad
{
    ...
    [imagenController setImage:[UIImage imageNamed:@"edhardy.png"]];
    UIImage *calaverita=[UIImage imageNamed:@"edhardy.png"];
