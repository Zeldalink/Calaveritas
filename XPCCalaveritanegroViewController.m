//
//  XPCCalaveritanegroViewController.m
//  Calaveritas
//
//  Created by Xochitl Perez on 20/10/12.
//  Copyright (c) 2012 Xochitl Perez. All rights reserved.
//

#import "XPCCalaveritanegroViewController.h"

@interface XPCCalaveritanegroViewController ()

@end

@implementation XPCCalaveritanegroViewController
@synthesize name;
...
- (void)viewDidLoad
{
    ...
    [imagenController setImage:[UIImage imageNamed:@"metal.png"]];
    UIImage *calaverita=[UIImage imageNamed:@"metal.png"];
