...
@interface XPCgrafittiViewController ()

@end

@implementation XPCgrafittiViewController
@synthesize name;
...
- (void)viewDidLoad
{
    ...
    [imagenController setImage:[UIImage imageNamed:@"grafitti.png"]];
    UIImage *calaverita=[UIImage imageNamed:@"grafitti.png"];
    ...
    [self.view addSubview:textController];
