...
@interface XPCSantoViewController ()

@end

@implementation XPCSantoViewController
...
- (void)viewDidLoad
{
    ...
    [imagenController setImage:[UIImage imageNamed:@"santo.png"]];
    UIImage *calaverita=[UIImage imageNamed:@"santo.png"];
