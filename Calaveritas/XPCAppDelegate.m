...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = [[XPCViewController alloc] initWithNibName:@"XPCViewController" bundle:nil];
    
   // self.viewController = [[ChooseImageViewController alloc] initWithNibName:@"ChooseImageViewController" bundle:nil];
