...
@interface XPCmoctezumaViewController ()

@end

@implementation XPCmoctezumaViewController
@synthesize name;
...
- (void)viewDidLoad
{
    ...
    [imagenController setImage:[UIImage imageNamed:@"moctezuma.png"]];
    UIImage *calaverita=[UIImage imageNamed:@"moctezuma.png"];
