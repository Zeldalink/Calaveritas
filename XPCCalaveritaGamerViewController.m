//
//  XPCCalaveritaGamerViewController.m
//  Calaveritas
//
...
@interface XPCCalaveritaGamerViewController ()

@end

@implementation XPCCalaveritaGamerViewController
@synthesize name;
...
- (void)viewDidLoad
{
    ...
    [imagenController setImage:[UIImage imageNamed:@"8bit.png"]];
