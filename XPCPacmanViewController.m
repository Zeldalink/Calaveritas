...
@interface XPCPacmanViewController ()

@end

@implementation XPCPacmanViewController
@synthesize name;
...
- (void)viewDidLoad
{
    ...
    [imagenController setImage:[UIImage imageNamed:@"pacman.png"]];
    UIImage *calaverita=[UIImage imageNamed:@"pacman.png"];
