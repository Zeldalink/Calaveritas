//
//  XPCTradicionalViewController.m
//  Calaveritas
//
...
@interface XPCTradicionalViewController ()

@end

@implementation XPCTradicionalViewController
...
- (void)viewDidLoad
{
    ...
    [imagenController setImage:[UIImage imageNamed:@"tradicional.png"]];
    UIImage *calaverita=[UIImage imageNamed:@"tradicional.png"];
